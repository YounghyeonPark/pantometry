...
thirty-one scenes and their closed-form checks live there now:
...
`#![deny(missing_docs)]` in all **twenty-four** crates. A one-line summary that names the unit is enough
