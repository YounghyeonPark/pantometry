...
**The thirty-two scenes left the library's gate.** Their closed-form checks — scene 21's
...
| `pantometry-world` | the scene format, the `World` builder, the verify battery, and the thirty-two scenes |
