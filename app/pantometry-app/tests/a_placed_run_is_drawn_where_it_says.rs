...
//! scene that states no pose**, which is thirty-one of the thirty-two shipped. A missed site collapses
...
fn a_run_that_states_no_placement_is_drawn_exactly_as_it_was() {
    // Thirty-one of the thirty-two shipped scenes and every run written before format 2. The
