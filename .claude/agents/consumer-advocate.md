...
`app/pantometry-world` is the first consumer this library ever had. **Thirty-nine** findings have
come out of it, thirty-three of them fixed, and they include the only real physics defect found in
...
Six of the thirty-nine findings were recorded rather than actioned, and one of those because the
