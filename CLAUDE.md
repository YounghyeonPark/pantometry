...
| [app/pantometry-world/FRICTION.md](app/pantometry-world/FRICTION.md) | changing the public API. Thirty-eight findings from using the SDK as a stranger, five of them the same underlying decision |
